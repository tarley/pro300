					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>Gestão <small>Grupos</small></h3>
								</div>
								<div class="col-md-6">
...
<div class="accordion" id="accordion6" role="tablist" aria-multiselectable="true">
                    <div class="panel">
                      ...
                      <tr class="even pointer">
						...
						<br/>
						<a> 
                      		<th><button type="button" class="btn btn-primary">Salvar</button></th>
                      	</a>
				...
				<footer>
					<div class="copyright-info">
						<p class="pull-right"> <a href="https://colorlib.com"> </a>		
						</p>
					</div>
					<div class="clearfix"></div>
				</footer>
	...
	<!--			$('.iCheck-helper').click(function() {
				if($(this).parent().prop("class", "icheckbox_flat-green checked")){
