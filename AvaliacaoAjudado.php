					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>Formulario de Avaliação para o Ajudante<small></small></h3>
								</div>
								<div class="col-md-6">
						...
						<p>Prezado Ajudante,
						neste formulário você deverá avaliar, com bastante honestidade, o nível de ajuda oferecida a cada integrante do grupo com base na escala de 1 a 5. <br/>
