			...
			<div class="">
				...
				<div class="page-title">
					<div class="title_left">
						<h3>Editar Cadastro Avaliação</h3><!-- Título da Página -->
					</div>
				</div>
...
<script>
	...
	$("#confirmar").click(function(e) {
		...
		$.post("classes/Atividade.class.php?acao=alterar", { token: token, descricao: descricao, dataInicio: dataInicio, dataFim: dataFim, cod_atividade: codAtividade})
